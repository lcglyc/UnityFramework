...
namespace ET
{
    ...
    public static class TimerComponentSystem
    {
        ...
        private static void Run(this TimerComponent self, TimerAction timerAction)
        {
            switch (timerAction.TimerClass)
            {
                ...
                case TimerClass.OnceWaitTimer:
                    {
                        UniTask<bool> tcs = timerAction.Object as UniTask<bool>;
                        self.Remove(timerAction.Id);
                        tcs.SetResult(true);
                        break;
                    }
        ...
        public static async UniTask<bool> WaitTillAsync(this TimerComponent self, long tillTime, ETCancellationToken cancellationToken = null)
        {
            ...
            UniTask<bool> tcs = UniTask<bool>.Create(true);
        ...
        public static async UniTask<bool> WaitFrameAsync(this TimerComponent self, ETCancellationToken cancellationToken = null)
        {
            bool ret = await self.WaitAsync(1, cancellationToken);
            return ret;
        }

        public static async UniTask<bool> WaitAsync(this TimerComponent self, long time, ETCancellationToken cancellationToken = null)
        {
            if (time == 0)
            {
                return true;
