...
namespace ET
{
    ...
    public static class ObjectWaitSystem
    {
        ...
        {
            private UniTask<K> tcs;

            public ResultCallback()
            {
                this.tcs = UniTask<K>.Create(true);
            }
            ...
            public UniTask<K> Task => this.tcs;
        ...
        public static async UniTask<T> Wait<T>(this ObjectWait self, ETCancellationToken cancellationToken = null) where T : struct, IWaitType
        {
        ...
        public static async UniTask<T> Wait<T>(this ObjectWait self, int timeout, ETCancellationToken cancellationToken = null) where T : struct, IWaitType
        {
            ResultCallback<T> tcs = new ResultCallback<T>();
