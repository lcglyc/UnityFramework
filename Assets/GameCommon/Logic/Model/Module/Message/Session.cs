...
namespace ET
{
    public readonly struct RpcInfo
    {
        ...
        public readonly UniTask<IResponse> Tcs;

        public RpcInfo(IRequest request)
        {
            this.Request = request;
            this.Tcs = UniTask<IResponse>.Create(true);
        }
    }
    ...
    public static class SessionSystem
    {
        ...
        public static async UniTask<IResponse> Call(this Session self, IRequest request, ETCancellationToken cancellationToken)
        {
