...
namespace ECSModel
{
    ...
    public class TimerComponent : Component
    {
        ...
        public UniTask WaitTillAsync(long tillTime, CancellationToken cancellationToken)
        {
        ...
        public UniTask WaitTillAsync(long tillTime)
        {
            UniTaskCompletionSource tcs = new UniTaskCompletionSource();
            Timer timer = new Timer { Id = IdGenerater.GenerateId(), Time = tillTime, tcs = tcs };
            this.timers[timer.Id] = timer;
        ...
        public UniTask WaitAsync(long time, CancellationToken cancellationToken)
        {
            UniTaskCompletionSource tcs = new UniTaskCompletionSource();
        ...
        public UniTask WaitAsync(long time)
        {
            UniTaskCompletionSource tcs = new UniTaskCompletionSource();
            Timer timer = new Timer { Id = IdGenerater.GenerateId(), Time = TimeHelper.Now() + time, tcs = tcs };
            this.timers[timer.Id] = timer;
