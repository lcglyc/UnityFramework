...
namespace ECSModel
{
	...
	public class TimerComponent : Component
	{
		...
		public ECSTask WaitTillAsync(long tillTime, CancellationToken cancellationToken)
		{
		...
		public ECSTask WaitTillAsync(long tillTime)
		{
			ECSTaskCompletionSource tcs = new ECSTaskCompletionSource();
			Timer timer = new Timer { Id = IdGenerater.GenerateId(), Time = tillTime, tcs = tcs };
			this.timers[timer.Id] = timer;
		...
		public ECSTask WaitAsync(long time, CancellationToken cancellationToken)
		{
			ECSTaskCompletionSource tcs = new ECSTaskCompletionSource();
		...
		public ECSTask WaitAsync(long time)
		{
			ECSTaskCompletionSource tcs = new ECSTaskCompletionSource();
			Timer timer = new Timer { Id = IdGenerater.GenerateId(), Time = TimeHelper.Now() + time, tcs = tcs };
			this.timers[timer.Id] = timer;
