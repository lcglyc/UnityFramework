...
namespace ET
{
    ...
    public static class MoveComponentSystem
    {
        ...
        public static async UniTask<bool> MoveToAsync(this MoveComponent self, List<Vector3> target, float speed, int turnTime = 100, ETCancellationToken cancellationToken = null)
        {
            self.Stop();
